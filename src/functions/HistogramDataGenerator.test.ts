...
describe('HistogramDataGenerator', () => {
    ...
    test('should generate bin data count list : type=leftHigh データ数13 階層数5', () => {
        const histogramConfig = {
            lowerLimit: 0,
            upperLimit: 100,
            decimalPlaces: 0,
        ...
        const expectedBinDataCountList = [3, 4, 3, 2, 1];
        expect(binDataCountList).toEqual(expectedBinDataCountList);
    });
    ...
    test('should generate bin data count list : type=leftHigh データ数13 階層数5', () => {
        ...
        const expectedBinDataCountList = [4, 5, 3, 2, 1];
        expect(binDataCountList).toEqual(expectedBinDataCountList);
    });
    ...
    test('should generate bin data count list : type=rightHigh データ数13 階層数5', () => {
        ...
        const expectedBinDataCountList = [1, 2, 3, 4, 3];
        expect(binDataCountList).toEqual(expectedBinDataCountList);
    });

    test('should generate bin data count list : type=rightHigh データ数15 階層数5', () => {
        const histogramConfig = {
            lowerLimit: 0,
            upperLimit: 100,
            decimalPlaces: 0,
